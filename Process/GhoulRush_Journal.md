# Ghoul Rush - Final Project Journal (Weeks 7-12)

This is the final project journal for CART 315 (Winter 2025). It covers Ghoul Rush from concept to build polish.

## Quick Links
- Team repo: [CART315FinalProject](https://github.com/Noe235/CART315FinalProject)
- Highlights: [HIGHLIGHTS.md](../HIGHLIGHTS.md)
- Full class journal (Weeks 1-12): [Journal.md](./Journal.md)
- Media folder: [FinalProject images](./Images/FinalProject)
